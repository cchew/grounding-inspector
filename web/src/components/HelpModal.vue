    ...
    <div class="modal-panel" role="dialog" aria-modal="true" aria-label="How Grounding Inspector works">
      ...
      <section class="modal-section">
        ...
        <ul>
          ...
          <li><strong>Omissions.</strong> A separate signal flags source sections whose content looks semantically absent from the AI output. It is unvalidated: no ground-truth omission labels exist for these fixtures and its hyperparameters are unadjusted defaults. It also compares each section against the rest of the same document, so a document with only a few sections may flag nothing no matter what was left out.</li>
