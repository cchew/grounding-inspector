...
class ProvenanceRecorder:
    ...
    def __init__(self, fixture_id: str):
        ...
        self.doc.set_default_namespace(f"https://grounding-inspector.dev/prov/{fixture_id}/")
    ...
    def declare_entity(self, entity_id: str, attrs: dict | None = None):
        """Declare an Entity with attributes but no Activity relation -- for
        source inputs that are used but never generated by anything this
        recorder models (e.g. source_doc, scorecard). Memoised like every
        other entity; safe to call before or after record_used/record_derived
        reference the same id."""
        return self._entity(entity_id, attrs)
